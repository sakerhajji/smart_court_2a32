...
class affaire_juridique
{
    public:
        ...
        void Setnumcas(QString val) { numcas = val; }
        ...
        QString Gettypecas() { return typecas; }
        void Settypecas(QString val) { typecas = val; }
        QString Getdatecas() { return datecas; }
        ...
        QString Getnbenfant() { return nbenfant; }
        void Setnbenfant(QString val) { nbenfant = val; }
        bool ajouteraffaire () ;
