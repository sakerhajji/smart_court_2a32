...
bool Avocat :: modifier ( int Id_Avocat _nouv,int Id_Avocat ,  int Numero_telephone , int Nombre_Proces_Gagnes   )
{
QSqlQuery query ;
QString Id_Avocat_String=QString :: number(Id_Avocat);
QString Numero_telephone_string=QString:: number(Numero_telephone);
QString Nombre_Proces_Gagnes_string=QString:: number(Nombre_Proces_Gagnes);
QString Id_Avocat_nouv_String =QString:: number(Id_Avocat_nouv);

query.prepare(" Update avocat set  Numero_telephone = :number , Nombre_Proces_Gagnes= :cases where Id_Avocat=: Id_Avocat_C   ")
