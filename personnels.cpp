...
bool personnels::supprimerp(int id)
{
    QSqlQuery query;
...
QSqlQueryModel*personnels::afficherp()
{
...
void personnels::archiverp(int id)
{
    QString res=QString ::number(id);
     QSqlQuery query;
...
QSqlQueryModel*personnels::afficher_historiquep()
{
...
QSqlQueryModel * personnels::affichertriAZp()
{   QSqlQueryModel *model=new QSqlQueryModel();
model->setQuery("SELECT * from personnels order by prenom Asc");
return model;
}
QSqlQueryModel * personnels::affichertriZAp()
{   QSqlQueryModel *model=new QSqlQueryModel();
model->setQuery("SELECT * from personnels order by prenom DESC");
return model;
}
QSqlQueryModel *personnels::rechercherp(QString rech)
{
    QSqlQueryModel *model= new QSqlQueryModel();
...
QSqlQueryModel *personnels::recherchernomp(QString nom)
{
    QSqlQueryModel *model= new QSqlQueryModel();
...
QStringList personnels::listeadressesp(QString var){
    QSqlQuery query;
...
int personnels::calcul_adressesp(QString adresse,QString val)
{
    QSqlQuery query;
